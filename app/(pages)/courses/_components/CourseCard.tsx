...
export default function CourseCard({ course, variant = "left" }: CourseCardProps) {
    ...
    const handleBookingSubmit = (data: { preferredDate: string; contactInfo: string; contactType: string }) => {
        ...
        const subject = `Booking Inquiry: ${course.title}`;
        const body = `Hello,

I am interested in booking the ${course.title}.
                ...
                <div className={`flex flex-col ${isRight ? "lg:flex-row-reverse" : "lg:flex-row"}`}>
                    ...
                    <div className="lg:w-1/2 p-6 lg:p-8 flex flex-col justify-center">
                        ...
                        <button
                            ...
                            className="inline-flex items-center justify-center gap-2 bg-[#A12717] hover:bg-[#8B1F12] text-white font-semibold py-3.5 px-6 rounded-lg transition-all duration-300 hover:shadow-lg group/btn cursor-pointer"
                        >
