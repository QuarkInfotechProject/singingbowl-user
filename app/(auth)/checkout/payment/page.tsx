    ...
    const initializeGetPay = () => {
        ...
        try {
            ...
            const getPayOptions: Record<string, any> = {
                ...
                // IMPORTANT: Do NOT redirect here manually. Let the SDK handle recursion via successUrl if configured.
                // The SDK seems to call onSuccess prematurely in some cases, so we avoid manual action here.
                onSuccess: (data: any) => {
                    console.log("GetPay Success Callback (No manual redirect):", data);
                },
                onError: (error: any) => {
